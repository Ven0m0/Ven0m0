...
- ⭐ **[steelseriesgg-rs](https://github.com/Ven0m0/steelseriesgg-rs)** — 58 stars · Open-source SteelSeries GG replacement for Linux. Control SteelSeries keyboards and headsets: RGB lighting, GameSense-compatible server, profiles, and (optional) audio/Sonar integration.
...
<!--LAST_REPOS:START-->
- [scoop-bucket](https://github.com/Ven0m0/scoop-bucket) — No description yet <sub>2026-08-26</sub>
...
- [mcpe](https://github.com/Ven0m0/mcpe) — Minecraft bedrock behavior packs/texture packs <sub>2026-08-25</sub>
