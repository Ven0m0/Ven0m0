...
- ⭐ **[steelseriesgg-rs](https://github.com/Ven0m0/steelseriesgg-rs)** — 68 stars · Open-source SteelSeries GG replacement for Linux. Control SteelSeries keyboards and headsets: RGB lighting, GameSense-compatible server, profiles, and (optional) audio/Sonar integration.
...
<!--LAST_REPOS:START-->
- [android](https://github.com/Ven0m0/android) — No description yet <sub>2026-09-21</sub>
- [dotfiles-pi](https://github.com/Ven0m0/dotfiles-pi) — My raspberry pi debian dotfiles and stuff <sub>2026-09-21</sub>
- [winiso](https://github.com/Ven0m0/winiso) — No description yet <sub>2026-09-21</sub>
- [MC-Server](https://github.com/Ven0m0/MC-Server) — Minecraft server management scripts <sub>2026-09-20</sub>
- [gemini-web-wrapper](https://github.com/Ven0m0/gemini-web-wrapper) — A Bun + FastAPI monorepo for running a mobile-friendly AI workspace in the browser, backed by a configurable LLM gateway and repository indexing APIs. <sub>2026-09-20</sub>
<!--LAST_REPOS:END-->
